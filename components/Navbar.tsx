...
export default () => {
  return (
    <>
      ...
      {/*    <Link className="navbar-brand hover:underline" href="/">Home</Link>*/}
      {/*    <Link className=" hover:underline" href="/">BWRL</Link>*/}
      {/*    <Link className=" hover:underline" href="/">BPSL</Link>*/}
      {/*    <Link className=" hover:underline" href="/">Schedule</Link>*/}
      {/*    <Link className=" hover:underline" href="/">Merch</Link>*/}
      ...
      {/*    <Link className="hover:underline mr-3" href="/">Login</Link>*/}
      {/*    <Link className="hover:underline" href="/"><FaFacebook size={24}/></Link>*/}
      {/*    <Link className="hover:underline" href="/"><FaInstagram size={24}/></Link>*/}
      {/*    <Link className="hover:underline" href="/"><FaTwitter size={24}/></Link>*/}
      {/*    <Link className="hover:underline" href="/"><FaTwitch size={24}/></Link>*/}
      {/*    <Link className="hover:underline border-2 p-3 border-black ml-6 " href="/">Watch Live</Link>*/}
      {/*  </div>*/}
      {/*</nav>*/}
    </>
  )
